    ...
    <div className="flex max-w-6xl mx-auto flex-col items-center justify-center py-2 min-h-screen">
      ...
      <main className="flex flex-1 w-full flex-col items-center justify-center text-center px-4 sm:mt-20 mt-20 background-gradient">
        ...
        <Link
          ...
          href="/dream"
        >
          Genera tu diseño ahora.
        </Link>
        <div className="flex justify-between items-center w-full flex-col sm:mt-10 mt-6">
          <div className="flex flex-col space-y-10 mt-4 mb-16">
            <div className="flex sm:space-x-8 sm:flex-row flex-col">
              <div>
                <h3 className="mb-1 font-medium text-lg">Tu Espacio Original</h3>
                <Image
                  alt="Original photo of a room with remodela.ai"
                  src="/1.jpg"
              ...
              <div className="sm:mt-0 mt-8">
                <h3 className="mb-1 font-medium text-lg">Tu Espacio Renovado </h3>
                <Image
                  alt="Generated photo of a room with remodela.ai"
                  width={400}
                  height={400}
                  src="/1-new.jpg"
